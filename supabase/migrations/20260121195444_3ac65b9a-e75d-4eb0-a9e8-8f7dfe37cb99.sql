-- Force drop all versions by using CASCADE and specific signatures
DROP FUNCTION IF EXISTS public.sp_get_terms(integer, integer, integer, text, integer, integer) CASCADE;
DROP FUNCTION IF EXISTS public.sp_get_terms(integer, integer, text, integer, integer, integer) CASCADE;

-- Recreate the function with a unique signature
