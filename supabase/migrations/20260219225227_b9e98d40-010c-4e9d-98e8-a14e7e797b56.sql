...
BEGIN
  ...
  INSERT INTO orders (
    ...
    subtotal, discount, total, user_id, branch_id, date
  ) VALUES (
    (p_order_data->>'document_type')::BIGINT,
    p_order_data->>'document_number',
    p_order_data->>'customer_name',
  ...
  -- ============================================================
  -- STEP 3: Pagos y Movimientos Financieros
  -- ============================================================
  FOR v_payment IN SELECT * FROM jsonb_array_elements(p_payments)
  LOOP
    -- Use business_account_id from payment JSON if provided and > 0, else fallback to payment_method's
