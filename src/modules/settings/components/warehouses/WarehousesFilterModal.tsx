        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md">
                ...
                {/* Tope de altura + scroll interno: los filtros son cascada de
                    sucursal, país, provincia, ciudad y distrito, y sin esto el
                    modal se estira hasta dejar el footer fuera de la pantalla. El
                    max-h va en un contenedor propio, no en el ScrollArea ni en el
                    DialogContent. El pr-4 aparta el contenido de la barra de
                    scroll, que si no roza el borde derecho de los selects. */}
