...
interface InventoryTableProps {
    ...
    isEditing: boolean;
    getStockValue: (variationId: number,
        warehouseId: number,
        originalStock: number) => string | number;
    handleStockChange: (variationId: number,
        warehouseId: number,
        value: string) => void;
}

const InventoryTable = ({ inventory, warehouses, isEditing, getStockValue, handleStockChange }: InventoryTableProps) => {
    return (
        <Table>
            <TableHeader>
                <TableRow>
