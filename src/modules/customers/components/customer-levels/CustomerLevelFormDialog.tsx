  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" aria-describedby={undefined}>
        ...
        {/* Header y footer fijos; solo el cuerpo scrollea (mismo patron que los
            modales de filtro: contenedor max-h-[50vh] + ScrollArea h-full, y el
            padding pl-1 pr-4 en el contenido para no rozar la barra). */}
