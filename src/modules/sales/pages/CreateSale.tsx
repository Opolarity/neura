...
const WhatsAppSendButton = ({
  ...
  return (
    <Button asChild size="icon" className="flex-shrink-0 bg-[#25D366] hover:bg-[#25D366]">
      <a
        href={`https://api.whatsapp.com/send?phone=${phone}&text=Hola%20${customerName ?? "Crew"}%20%F0%9F%91%BD%F0%9F%91%8B%20Te%20comento%20que%20tu%20pedido%20${orderId}%20est%C3%A1%20siendo%20procesado%20%F0%9F%9A%80.%20En%20un%20momento%20pasaremos%20a%20armar%20tu%20pedido%20%F0%9F%93%A6.`}
        target="_blank"
...
const CreateSale = () => {
  ...
  const totalPaid = payments.reduce((acc, payment) => {
    if (payment.completed !== true) return acc
